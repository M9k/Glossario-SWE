	...
	\section{Progettazione}
		...
		\section{Verifica e validazione}
			\subsection{Introduzione}
				...
				-Logget: componente non instrusivo di registrazione dei dati per l'analisi dei risultati\\
				...
				Più rapido, meno collaborativo\\
				Fasi, ognuna documentata:\\
				-Pianificazione\\
				-*Definizione \textit{lista di controllo}\\
				-Lettura\\
				-Discussione\\
				-Correzione di difetti\\
				
				\textbf{Quality assurance}\\
				Raccolta tempestiva e oggettiva di qualità per controllo interno ed accertamento esterno\\
