...
\section{Glossario}
	...
	\section{Progettazione}
		...
		Misurazione quantitativa: l'uso di una metrica per assegnare un valore, numerico o categoria, su una scala predefinita\\
		Quello che misuriamo è ciò che vogliamo conoscere\\
		
		\textbf{ISO 25000 - 9126 + 14598}\\
		Qualsiasi prodotto e processo deve essere quantificato, per identificare componenti anomale o prevedere l'avanzamento\\
		Qualsiasi proprietà o attributo software deve essere misurato\\
		Si sa come misurare la visione interna, ma importante la visione esterna, che dipende dagli attributi interni\\
		 
		 {\large GRAFI VARI?}\\
		 
		 \textbf{Qualità del ciclo di vita}\\
		 -Qualità obbiettivo: soddisfacimento dei requisiti, dettata e verificata dal committente\\
		 -Qualità richiesta, da contratto: dettata e verificata dal committente\\
		 -Qualità progettata\\
		 -Qualità stimata\\
		 -Qualità consegnata\\
